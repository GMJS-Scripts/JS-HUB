# JS Library
This documentation is for the stable release of JS Library.
...
## Creating a Window
```lua
local Window = JSLib:MakeWindow({Name = "Title of the library", HidePremium = false, SaveConfig = true, ConfigFolder = "JSTest"})
...
print(JSLib.Flags["toggle"].Value) -- prints the value of the toggle.
```
